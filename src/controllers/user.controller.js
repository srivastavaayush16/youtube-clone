...
const getCurrentUser = asyncHandler(async(req, res)=>{
    return res
    .status(200)
    .json(new ApiReponse(200, req.user, "current user fetched successfully"))
})
...
const updateAccountDetails = asyncHandler(async(req, res)=>{
    ...
    return res
    .status(200)
    .json(new ApiReponse(200, user, "Account details updated successfully"))
...
const updateUserAvatar = asyncHandler(async(req, res)=>{
    ...
    //delete old image - write function fo that
    ...
    .status(200)
    .json(
        new ApiReponse(200, user, "avatar updated successfully")
    )
})
...
const getUserChannelProfile = asyncHandler(async(req, res)=>{
    ...
    const channel = await User.aggregate([
        {
            $match:{                        //user ko match kara
                username: username?.toLowerCase()
            }
        },
        {
            $lookup:{                       //subscribers kitne h channel k through
                from: "subscriptions",
                localField: "_id",
        ...
        {
            $lookup:{                       //aapne kitno ko subscribe kr rkha h
                from: "subscriptions",
                localField: "_id",
...
const getWatchHistory = asyncHandler(async(req, res)=>{
    ...
    return res
    .status(200)
    .json(new ApiReponse(200, user[0].watchHistory, "watch history fetched successfully"))
})
